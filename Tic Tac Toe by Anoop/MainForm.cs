...
namespace Tic_Tac_Toe_by_Anoop
{
	...
	public partial class MainForm : Form
	{
        ...
        private void button12_Click(object sender, EventArgs e)
        {
            ...
            if (max == a && max == b && max == c) { MessageBox.Show(" The best Score is Person x , " + textBox1.Text + " and " + textBox2.Text); }
            else if (max == a && max == b) { MessageBox.Show(" The best Score is Person x and " + textBox1.Text); }
            else if (max == a && max == c) { MessageBox.Show(" The best Score is Person x and " + textBox2.Text); }
